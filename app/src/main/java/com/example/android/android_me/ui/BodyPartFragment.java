...
public class BodyPartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // Otherwise, create a Log statement that indicates that the list was not found
            if (mImages != null) {
           imageView.setImageResource(mImages.get(mIndexImages));
            }  else {
                Log.d(TAG, "This fragment has a null list of Index Ids ");
            }
        // Return the rootView
        return rootView;
    }
    ...
    public void setmIndexImages(int indexImages) {
        mIndexImages = indexImages;
    }
